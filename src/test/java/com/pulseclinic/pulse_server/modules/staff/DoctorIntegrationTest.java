...
class DoctorIntegrationTest {
    ...
    void setUp() {
        ...
        entityManager.createNativeQuery("TRUNCATE TABLE appointments, doctors, staff, patients, rooms, departments, users, roles RESTART IDENTITY CASCADE").executeUpdate();
